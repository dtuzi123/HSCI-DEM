...
class LifeLone_MNIST(object):
    ...
    def Create_VAEs(self,index,selectedComponentIndex):
        ...
        if self.componentCount == 0:
            ...
            reco = Generator_SVHN_Tanh(SubGeneratorStr, continous_variables1_super, batch_size=64,
                                          reuse=False)

            feature = 0
            # generation
            reco2 = Generator_SVHN_Tanh(SubGeneratorStr, self.z, batch_size=64,
                                           reuse=True)
