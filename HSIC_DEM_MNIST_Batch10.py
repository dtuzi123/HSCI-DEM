                    ...
                    if self.componentCount == 1:
                        ...
                        for kk in range(self.componentCount-1):
                            ...
                            for i in range(mycount2):
                                ...
                                dHSIC_Value = self.sess.run(self.HSIC,feed_dict={self.z:code1,self.z2:code2})
                                dhsic = dhsic + dHSIC_Value

                            dhsic = dhsic / mycount2
                            dhsicArr.append(dhsic)

                        disMin = np.max(dhsicArr)
                        threshold = 0.047
                        print(disMin)
